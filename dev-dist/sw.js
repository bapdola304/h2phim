...
define(['./workbox-5d155c7a'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/ophim1\.com\/v1\/api\/.*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https:\/\/img\.ophim\.(live|cc)\/.*/i, new workbox.CacheFirst({
